...
I2C_ADDRESS_A = const(0x28)
I2C_ADDRESS_B = const(0x29)
...
REGISTER_CHIP_ID = const(0x00)
REGISTER_PAGE_ID = const(0x07)

REGISTER_EULER_HEADING_LSB = const(0x1A)
REGISTER_EULER_HEADING_MSB = const(0x1B)
REGISTER_EULER_ROLL_LSB = const(0x1C)
REGISTER_EULER_ROLL_MSB = const(0x1D)
REGISTER_EULER_PITCH_LSB = const(0x1E)
REGISTER_EULER_PITCH_MSB = const(0x1F)

REGISTER_UNIT_SELECTION = const(0x3B)
REGISTER_OPERATION_MODE = const(0x3D)
REGISTER_POWER_MODE = const(0x3E)
